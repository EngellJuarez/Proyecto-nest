...
CREATE TABLE "PostCategory" (
    ...
    "catergotyId" INTEGER NOT NULL,

    PRIMARY KEY ("postId", "catergotyId"),
    CONSTRAINT "PostCategory_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "PostCategory_catergotyId_fkey" FOREIGN KEY ("catergotyId") REFERENCES "Category" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
